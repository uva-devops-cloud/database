...
(
    ...
    semester VARCHAR(10)
    -- optional if it's fixed; could also move to a student-course table
);
...
(
    ...
    program_id INT NOT NULL,
    gpa NUMERIC(4,2),
    -- Example for storing a GPA up to 9.99
...
(
    ...
    course_id INT NOT NULL,
    program_id INT,
    -- optional if you need to know which program the course belongs to
    grade VARCHAR(2),
    status VARCHAR(20),
    semester VARCHAR(10),
    FOREIGN KEY (student_id) REFERENCES students (student_id),
